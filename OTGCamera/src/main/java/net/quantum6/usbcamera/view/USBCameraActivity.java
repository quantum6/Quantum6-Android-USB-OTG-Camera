package net.quantum6.usbcamera.view;
...
import net.quantum6.usbcamera.R;
...
import net.quantum6.usbcamera.utils.FileUtils;
...
public class USBCameraActivity extends AppCompatActivity implements CameraDialog.CameraDialogParent, CameraViewInterface.Callback {
    ...
    private void initView() {
        ...
        mDebugInfo.setText("mSeekBrightness");
        ...
        mSeekBrightness.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                if (mCameraHelper == null)
                {
                    text = "mCameraHelper = null";
                }
                else
                {
                    text = "isCameraOpened()="+mCameraHelper.isCameraOpened();
                }
                //Toast.makeText(mInstance, text, Toast.LENGTH_LONG);
    ...
    private final static int MESSAGE_SHOW_TEXT = 0;
    private final static int MESSAGE_FRAME_COUNT = 1;
    ...
    private Handler mDebugHandler = new Handler()
    {
        ...
        public void handleMessage(Message msg)
        {
            ...
            switch (msg.what)
            {
                ...
                case MESSAGE_FRAME_COUNT:
                    mDebugHandler.sendEmptyMessageDelayed(MESSAGE_FRAME_COUNT, 1000);
                    break;
    ...
    public static void showDebugText(String text)
    {
        if (mInstance.mDebugHandler != null) {
            mInstance.mDebugHandler.sendMessage(mInstance.mDebugHandler.obtainMessage(MESSAGE_SHOW_TEXT, text));
        }
    }
}
